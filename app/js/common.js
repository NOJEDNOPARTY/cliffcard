var common = {
	...
	main: function(){
		...
		$('.menu-open-trigger').click(function(event){
	...
	owl: function(){
		...
		$('.apartament-gallery-dots .owl-dot').click(function () {
			galleryDots.trigger('refresh.owl.carousel');
			gallery.trigger('to.owl.carousel', [$(this).parent().index(), 300]);
		});
